    ...
    <header class="py-6">
      <div class="flex">
        <ul class="flex items-center font-poppins leading-4 text-blue ">
          ...
          <li class="mr-9"><a class="relative before:block before:absolute before:h-0.5 before:w-3 before:bg-orange before:top-5" href="#">Home</a></li>
    ...
    <div class="flex gap-[275px] pt-[145px] pb-[79px]">
      <div>
        ...
        <ul class="flex gap-[14px]">
          <li class=" ">
            <a class="flex justify-center items-center rounded-full h-8 w-8 border border-solid cursor-pointer hover:border-orange" href="#">
